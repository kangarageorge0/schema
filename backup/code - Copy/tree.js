...
export class node extends outlook.view {
    ...
    get_tree_view_elements() {
        ...
        const hook = (this.parent === undefined) ? this.explorer.panel.tree : this.parent.tree.children;
        //
    ...
    */
    ...
    //the header
    create_tree_selection_element(anchor) {
        //
        ...
        const selector = this.create_element("div", anchor, {
            ...
            oncontextmenu: async () => await this.content.crud(this),
            //
...
(function (common) {
    ...
    class content {
        ...
        //view. By default, they are the same as the keys of the node's properties  
        get_header_names() {
            //
        ...
        //default, they are teh same as the properties of the node
...
(function (record) {
    ...
    class root extends content {
        ...
        async get_selection() {
            ...
            const desc = await server.exec('editor', [this.subject.ename, this.subject.dbname], 'describe', []);
            //
    ...
    class child extends content {
        ...
        parent) {
            ...
            const name = fname === undefined ? primarykey[1] : String(fuel[fname]);
            //
...
(function (service) {
    ...
    class content extends common.content {
        ...
        async get_children_content() {
            ...
            //contents
            const contents = this.products.map(product => {
                //
