...
class schema extends mutall {
    ...
    //provided as a json 
    function add_comments(string $json, string $dbname, string $ename, string $cname=""): void {
        //
        ...
        try {
            ...
            $msg = "Invalid json string in the comment of $dbname.$ename.$cname";
            //
    ...
    //  and attributes. I contains statements such as
...
class database extends schema {
    ...
    function activate_entities(): void {
        ...
        foreach ($tables as [$dbname, $ename, $comment]) {
            ...
            $entity->add_comments($comment, $dbname, $ename);
            //
    ...
    function activate_columns(): void {
        ...
        foreach ($columns as [$dbname, $ename, $cname, $data_type, $default, $is_nullable, $comment, $length, $key, $type]) {
            ...
            //to the column.
            $column->add_comments($comment, $dbname, $ename, $cname);
            //
